...
export const ReservationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="washLibraryApp.reservation.delete.question">
        <Translate contentKey="washLibraryApp.reservation.delete.question" interpolate={{ id: reservationEntity.id }}>
