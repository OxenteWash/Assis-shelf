...
describe('Category e2e test', () => {
  ...
  describe('new Category page', () => {
    ...
    it('should create an instance of Category', () => {
      cy.get(`[data-cy="name"]`).type('vivaciously');
      cy.get(`[data-cy="name"]`).should('have.value', 'vivaciously');

      cy.get(`[data-cy="description"]`).type('tidy anenst accept');
      cy.get(`[data-cy="description"]`).should('have.value', 'tidy anenst accept');
