...
describe('Reservation e2e test', () => {
  ...
  describe('new Reservation page', () => {
    ...
    it('should create an instance of Reservation', () => {
      cy.get(`[data-cy="dateReservation"]`).type('2025-06-09T17:31');
      cy.get(`[data-cy="dateReservation"]`).blur();
      cy.get(`[data-cy="dateReservation"]`).should('have.value', '2025-06-09T17:31');
